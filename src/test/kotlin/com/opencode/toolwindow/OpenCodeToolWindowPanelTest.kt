...
class OpenCodeToolWindowPanelTest {
    ...
    fun `test panel implements ViewCallback interface`() {
        ...
        assertTrue(callbackInterface.isAssignableFrom(OpenCodeToolWindowPanel::class.java),
    ...
    fun `test panel extends JPanel`() {
        // Assert
        assertTrue(JPanel::class.java.isAssignableFrom(OpenCodeToolWindowPanel::class.java),
    ...
    fun `test panel constructor accepts required parameters`() {
        ...
        assertEquals(OpenCodeService::class.java.name, paramTypes[1].name,
    ...
    fun `test onStateChanged method exists with correct signature`() {
        ...
        assertEquals(OpenCodeToolWindowViewModel.State::class.java, method.parameterTypes[0],
    ...
    fun `test panel has createTerminalWidget private method`() {
        ...
        // Assert
        assertTrue(methodNames.any { it.contains("createTerminalWidget") || it.contains("createWidget") },
    ...
    fun `test panel has process monitoring method`() {
        ...
        // Assert
        assertTrue(methodNames.any { it.contains("monitor", ignoreCase = true) || it.contains("check", ignoreCase = true) },
    ...
    fun `test panel integrates with ViewModel via composition`() {
        ...
        assertEquals(OpenCodeToolWindowViewModel::class.java, viewModelField!!.type,
